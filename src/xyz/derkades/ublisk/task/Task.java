...
import xyz.derkades.ublisk.DataFile.SaveFiles;
import xyz.derkades.ublisk.database.AddTrackersInfoToQueue;
import xyz.derkades.ublisk.database.ProcessQueue;

public enum Task {

	CHECK_TOWN(new CheckTown(), 0, 20, false),
