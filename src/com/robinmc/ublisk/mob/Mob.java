...
public enum Mob {
	 ...
	 * WARNING: DO NOT CHANGE IDs.
	 */
	
	SHEEP_LEVEL_1(1, new MobArea(
	...
	Mob(int id, MobArea area, MobType type, int level, double health, int minExp, int maxExp, int maxSpawn, String name, double rate, GoldDrop gold, MobDrop... drops){
		this.id = id;
